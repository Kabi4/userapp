                ...
                <Col span={6}>
                    <Card title="Edit User" style={{ width: 300 }}>
                        <Input.Group size="large">
                            <Row gutter={24}>
                                <Col span={24}>
                                    <Input onChange={(e) => { onInputsChanged({ field: 'firstName', value: e.target.value }) }} value={inputs.firstName} defaultValue="Email" />
                                </Col>
                            </Row>
                            <br />
                            <Row gutter={24}>
                                <Col span={24}>
                                    <Input onChange={(e) => { onInputsChanged({ field: 'lastName', value: e.target.value }) }} value={inputs.lastName} defaultValue="Email" />
                                </Col>
                            </Row>
                            <br />
                            <Row gutter={24}>
